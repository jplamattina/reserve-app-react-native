...
const ButtonMyReservation = () => {
  return (
    <View style={styles.container}>
      <CardMyReservations style={styles.card}>
          ...
          <Text style={styles.textMessage}>Mis Reservas</Text>
      </CardMyReservations>
...
export default ButtonMyReservation
